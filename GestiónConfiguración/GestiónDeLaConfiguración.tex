...
Planificación Ciclo 1 & C1 & Carlos Sobrino & SH-DOC-C1 & Planif. / GitHub \\
Monitorización Ciclo 1 & M1 & Carlos Sobrino & SH-DOC-M1 & Seguim. / GitHub \\
Presentación Ciclo 1 & P1 & Carlos Sobrino & SH-DOC-P1 & Cierre / GitHub \\
Planificación Ciclo 2 & C2 & Carlos Sobrino & SH-DOC-C2 & Planif. / GitHub \\
Monitorización Ciclo 2 & M2 & Carlos Sobrino & SH-DOC-M2 & Seguim. / GitHub \\
Presentación Ciclo 2 & P2 & Carlos Sobrino & SH-DOC-P2 & Cierre / GitHub \\
...
Durante el transcurso del proyecto, se han generado las siguientes peticiones de cambio que afectan directamente a la planificación y estructura del proyecto:\begin{itemize}
...
\begin{itemize}
    \item \textbf{PC-001 (23/03/2026):} Solicitada para reordenar la implementación de requisitos. Se adelantó el **REQ 3** al primer ciclo y se desplazó el **REQ 4** al Ciclo 2, incorporando además el **REQ 9**.
    \item \textbf{PC-002 (20/04/2026):} Definición formal de la estructura del CCC y asignación de roles GCS (Inspector, Secretario, Responsable de Desarrollo, Moderador y Lector) para cada integrante del equipo.
    \item \textbf{PC-003 (20/04/2026):} Modificación del alcance técnico eliminando el **REQ 6** y sustituyéndolo por el **REQ 8** para optimizar el tiempo disponible del equipo.
\end{itemize}
