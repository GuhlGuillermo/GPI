...
// Simulamos que el componente recibe sus props desde un "Menu" parent y una función manejadora onAddToCart proveniente de Zustand/Hook
const DishCard = ({ 
  dish = { id_plato: 'D1', nombre_plato: 'Momo de Pollo', descripcion: 'Empanadillas al vapor rellenas de carne marinada con especias del Himalaya.', precio_plato: 6.50, categoria: 'Entrantes' },
  onAddToCart 
}) => {
  return (
