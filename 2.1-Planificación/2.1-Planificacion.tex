...
El siguiente diagrama de Gantt detalla la planificación y la asignación de las tareas a lo largo del proyecto. La información se corresponde con las estimaciones de esfuerzo total de 65 horas (13 horas por integrante). En esta versión, se ha trasladado la tarea de revisión de código de Carlos al bloque de gestión de calidad.
...
\begin{itemize}
    ...
    \item \textbf{Gestion de la Configuración y Calidad} (13h):
    \begin{itemize}
...
\begin{longtable}{@{}lc@{}}
    ...
    \textbf{Gestion de la Configuración y Calidad} & \textbf{13 h} \\
    $\llcorner$ Gestión Configuración & 4 h \\
    $\llcorner$ Gestión Calidad & 9 h \\ \addlinespace

    \textbf{Desarrollo} & \textbf{27 h} \\
...
\begin{longtable}{@{}p{4.5cm} p{7.5cm} c@{}}
    ...
    - Revisión Código (Calidad): 2h \newline
    - Testing: 2h & \textbf{13 h} \\ \midrule
