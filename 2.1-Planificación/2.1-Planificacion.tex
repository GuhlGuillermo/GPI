...
El siguiente diagrama de Gantt detalla la planificación y la asignación de las tareas a lo largo del proyecto. La estructura de las tareas se corresponde fielmente con la imagen del diagrama, manteniendo el esfuerzo total de 65 horas (13 horas por integrante) estipulado para el equipo.

\begin{figure}[htbp]
    \centering
    % Se actualiza la extensión a .jpg según el nuevo diagrama
    \includegraphics[width=\textwidth]{diagrama_gantt.png} 
    \caption{Diagrama de Gantt de las tareas planificadas.}
    \label{fig:diagrama_gantt}
\end{figure}

A continuación, se detalla el desglose de las tareas y fases del proyecto, respetando la agrupación original del diagrama:

\begin{itemize}
    \item \textbf{Reuniones y Monitorización} (22h):
    \begin{itemize}
        \item \textbf{Reuniones} (Asignada a: Todos - 5h totales por reunión): 
        \begin{itemize}
...
Resumen del esfuerzo total estimado por fase para un total de 65 horas.
...
Distribución de tareas por integrante, cumpliendo con un total de \textbf{13 horas por persona}.
...
\begin{longtable}{@{}p{4.5cm} p{7.5cm} c@{}}
    ...
    - Transversales (4 Reuniones + Petición Cambio): 5h \newline
